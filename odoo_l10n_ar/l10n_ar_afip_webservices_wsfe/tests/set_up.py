...
class SetUp(common.TransactionCase):
    ...
    def _create_document_books(self):
        ...
        vals['document_type_id'] = self.env.ref('l10n_ar_point_of_sale.document_type_invoice_fce').id
        vals['denomination_id'] = self.env.ref('l10n_ar_afip_tables.account_denomination_a').id
        self.document_book_fce_a = document_book_proxy.create(vals)
