...
class TestWsfe(common.TransactionCase):
    ...
    def test_code_perception(self):
        assert self.env.ref('l10n_ar.1_perception_perception_iibb_pba_efectuada').get_afip_code() == 2
        assert self.env.ref('l10n_ar.1_perception_perception_iva_sufrida').get_afip_code() == 1
