...
class TestPaymentImputation(set_up.SetUp):
    ...
    def setUp(self):
        ...
        self.imputation = self._create_imputation(self.invoice, self.customer_payment)
    ...
    def test_multicurrency_imputation_rate_in_payment(self):
        ...
        self.payment_line.amount = 43.21
        self.imputation.amount = 43.21
        self.customer_payment.post_l10n_ar()

        assert not self.invoice.residual
