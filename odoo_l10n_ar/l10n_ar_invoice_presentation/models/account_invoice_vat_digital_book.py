...
class AccountInvoiceVatDigitalBook(models.Model):
    ...
    def get_invoices(self):
        """ Busco las facturas """
        return self.env['account.invoice'].search(self.get_domain_invoices())

    @staticmethod
    def get_total_notTaxed_taxes(invoice, data):
        """ Obtengo el total sin impuestos de una factura dada"""
    ...
    def generate_reginfo_zip_file(files):
        ...
        :param files: generators de las libro IVA digital
        :return: archivo zip
        """
