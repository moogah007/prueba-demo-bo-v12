...
class TestPresentationSaleIva(TransactionCase):
    ...
    def test_sale_vat_invoice_presentation(self):
        ...
        decoded = base64.decodebytes(self.account_invoice_presentation.sale_vat_file)
        # Tipo de comprobante
        assert decoded[0:3] == b"001"
        # Punto de venta
        assert decoded[3:8] == b"00001"
        # Numero de comprobante
        assert decoded[8:28] == b"00000000000000000008"
        # Importe neto gravado
        assert decoded[28:43] == b"000000000100000"
        # Alicuota de iva
        assert decoded[43:47] == b"0005"
        # Impuesto liquidado
        assert decoded[47:62] == b"000000000021000"
