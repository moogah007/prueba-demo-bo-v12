...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _get_lines(self, options, line_id=None):
        """ Se pisa la funcion para colocar correctamente las referencias de los documentos (Linea 105)"""
        ...
        for partner in sorted_partners:
            ...
            if 'partner_' + str(partner.id) in options.get('unfolded_lines') or unfold_all:
                ...
                for line in amls:
                    ...
                    domain_columns = [line.journal_id.code, line.account_id.code,
                                      line.invoice_id.name_get()[0][1] if line.invoice_id else line.name,
                ...
                if remaining_lines > 0:
                    domain_lines.append({
                        ...
                        'name': 'Cargando... (%s restante)' % remaining_lines,
