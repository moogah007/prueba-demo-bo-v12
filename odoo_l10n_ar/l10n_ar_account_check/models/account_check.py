...
class AccountThirdCheck(models.Model):
    ...
    _description = 'Cheque de tercero'
    ...
    not_to_order = fields.Boolean(string="No a la orden",
                                  help="Si está establecido este cheque no podrá ser elegido para realizar pagos")
