...
class AccountAbstractPayment(models.AbstractModel):
    ...
    def _get_third_check_vals(self):
        ...
        checks = (self.account_third_check_ids | self.account_third_check_sent_ids)
        third_check_account_id = self.env.user.company_id.third_check_account_id.id

        if not third_check_account_id and checks:
