...
class TestSaleSubscription(common.TransactionCase):
    ...
    def test_create_invoice_from_subscription(self):
        ...
        for invoice in invoices:
            assert invoice.date_service_from == fields.Date.today() + relativedelta(day=1) - relativedelta(months=1)
            assert invoice.date_service_to == fields.Date.today() + relativedelta(day=1) - relativedelta(days=1)
