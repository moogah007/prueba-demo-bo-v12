...
class TestResPartner(common.TransactionCase):
    ...
    def test_update_iibb_pba_values(self):
        ...
        assert perception_rule.date_from == date(2018, 8, 1)
        assert perception_rule.date_to == date(2018, 8, 31)
        ...
        assert retention_rule.date_from == date(2018, 8, 1)
        assert retention_rule.date_to == date(2018, 8, 31)
